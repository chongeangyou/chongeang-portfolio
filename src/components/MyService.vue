    ...
    <div class="container_fluid">
      ...
      <div class="services-feature py-3">
        <div class="row text-center">
          <div class="col-lg-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="140" height="140" viewBox="0 0 640 512">
          ...
          <div class="col-lg-4">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="140"
              height="140"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
              <path
